...
const ModalPerfilAdocaoPorsche = () => {
              ...
              <div className="infoModal">
                <div className="infopet">
                  <div className="fotoPetDiv">
                    <img src="https://s3.amazonaws.com/petz-cdm-stg/10d2fe5c-d299-4c09-ae42-a43fdf3bdd95.jpeg
                ...
                <div className="infoPeteUser">
                  <div className="quemAnunciou">
                    ...
                    <div className="infoAnunciante">
                      ...
                      <p className="nomeAnunciante">Rodrigo Souza</p>
                    </div>
                  </div>
...
export default ModalPerfilAdocaoPorsche