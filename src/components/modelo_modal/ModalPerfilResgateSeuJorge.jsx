...
const ModalPerfilResgateSeuJorge = () => {
              ...
              <div className="infoModal">
                <div className="infopet">
                  <div className="fotoPetDiv">
                    <img src="https://s3.amazonaws.com/petz-cdm-stg/7182ab81-1f6c-4068-b3bc-ba3b124b3b35.jpeg" alt="FotoPet" className="fotoPet" />
                  </div>
                  <div className="textpet">
                    ...
                    <p>Esse meninão foi encontrado no supermercado Shibata. Ele é muito dócil, está castrado e a procura de seu dono!</p>
                  </div>
                </div>
                <div className="infoPeteUser">
                  ...
                  <div className="Iconsinfo">
                    <div className="infoDopet">
                      ...
                      <span className="idade"><Porte/>Castrado</span>
                      <span><Raca />Persa</span>
                      <span> 
                        
                      </span>
                      <span className="localPet"><Local /> Foi encontrado no Centro </span>
...
export default ModalPerfilResgateSeuJorge
