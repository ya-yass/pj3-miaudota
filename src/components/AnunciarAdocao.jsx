          ...
          <form onSubmit={handleSubmitAdotado}>
            ...
            <Typography id="modal-modal-description" component="div"
              ...
              <div className='sobrePet'>
                ...
                <textarea name="descricao" rows="6" type="text" className='inputAdocao inputDescricao' InputLabelProps={{ shrink: true }} placeholder='Ex: O pet é calmo, não tem costume em ficar sozinho em casa, fica assustado com uma grande quantidade de pessoas dentro de casa...' />
              </div>
